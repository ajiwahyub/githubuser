package com.submisi2.githubuser.notification
...
import com.submisi2.githubuser.MainActivity
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun setRepeatingAlarm(context: Context, time: String) {
        ...
        Toast.makeText(context, "Repeating alarm has been seted", Toast.LENGTH_SHORT).show()
    }
    ...
    fun cancelAlarm(context: Context) {
        ...
        Toast.makeText(context, "Repeating alarm has been canceled", Toast.LENGTH_SHORT).show()
    }
